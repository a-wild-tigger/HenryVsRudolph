...
import com.mobilecomputing.src.Training.Examples.UDPClient;
...
public class StaticClassifier extends HandTrackingAdapter {
    ...
    public StaticClassifier(String aName) {
        aUsername = aName;
    }
    ...
    public static void Run(String theCurrentUser, ContinuousTrainedParameters myCTSParams, StaticTrainedParameters myStaticParams) {
        StaticClassifier demo = new StaticClassifier(theCurrentUser);
